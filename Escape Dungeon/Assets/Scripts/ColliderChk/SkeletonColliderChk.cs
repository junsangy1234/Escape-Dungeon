...
public class SkeletonColliderChk : MonoBehaviour
{
    bool isCan = true;
            ...
            case 8:
                {
                    if (isCan)
                    {
                        ...
                        {
                            GameManager.instance.PlayerHp = GameManager.instance.PlayerHp - 10;
                        }
                        else
                        {
                            GameManager.instance.PlayerHp = GameManager.instance.PlayerHp - 15;
                        }
